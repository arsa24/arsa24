  ...
  return (
    <div className="flex items-center justify-center text-xs">
      <div
        className={`p-1.5 ${
          color === "blue"
            ? "dark:bg-mocha-blue bg-latte-blue"
            : color === "red"
            ? "dark:bg-mocha-red bg-latte-red"
            : color === "green"
            ? "dark:bg-mocha-green bg-latte-green"
            : ""
      ...
      >
        {icon === "rust" ? (
          <svg
            ...
            fill="currentColor"
            viewBox="0 0 512 512"
            className="w-4 h-4 text-latte-surface0 dark:text-mocha-surface0"
          >
          ...
          <Code className="w-4 h-4 text-latte-surface0 dark:text-mocha-surface0" />
        ) : icon === "folder" ? (
          <Folder className="w-4 h-4 text-latte-surface0 dark:text-mocha-surface0" />
        ) : null}
      </div>
      <div
        className={`px-3 py-1.5 dark:bg-mocha-surface0 bg-latte-surface0 ${
          roundedbr ? "rounded-br-lg" : ""
        }`}
      >
        <p className="whitespace-nowrap text-latte-text dark:text-mocha-text">{name}</p>
      </div>
    </div>
  );
}
